...
import threading
import time
from aes_encryption import aes_encrypt_message, aes_decrypt_message, generate_key
            ...
            if message.startswith("[Group:"):
                try:
                    ...
                    if all(c in '0123456789abcdefABCDEF' for c in ciphertext.replace(" ", "")):
                        plaintext = aes_decrypt_message(ciphertext, key)
...
def format_and_encrypt_message(msg: str , key) -> str:
    ...
    if msg.startswith("sendto:"):
        ...
        if len(parts) == 3:
            ...
            encrypted = aes_encrypt_message(content.strip(), key)
